...
template <class real>
int WriteMatrixToDisk(char* g, int m, int n, real * matrix)
{
  FILE * file;
  file = fopen(g,"wb");
  if (!file)
...
template <class real>
int ReadMatrixFromDisk(char * g, int * m, int * n, real ** matrix)
{
  FILE * file;
  file = fopen(g,"rb");
  if (!file)
...
template <class real>
int WriteMatrixToDisk_(char* g, int m, int n, real * matrix)
{
  if (WriteMatrixToDisk(g, m, n, matrix) != 0)
    exit(1);
...
template <class real>
int ReadMatrixFromDisk_(char* g, int * m, int * n, real ** matrix)
{
  if (ReadMatrixFromDisk(g, m, n, matrix) != 0)
    exit(1);
...
int ReadMatrixSizeFromDisk(char * g, int * m, int * n)
{
  FILE * file;
  file = fopen(g,"rb");
  if (!file)
...
void ReadMatrixSizeFromDisk_(char * g, int * m, int * n)
{
  if (ReadMatrixSizeFromDisk(g,m,n) != 0)
    exit(1);
}
...
int OpenFile_(char * g, FILE ** fin, char * mode)
{
  *fin = fopen(g,mode);
  if (!(*fin))
  {
...
void ChangeMatrixHeader(char * g, int numRows, int numColumns)
{
  FILE * fin = fopen(g,"r+");
...
template <class real>
int ReadMatrixFromDiskTextFile(char* g, int * m, int * n, real ** matrix)
{
  // open input
  FILE * file;
  file = fopen(g,"r");
...
template <class real>
int WriteMatrixToDiskTextFile(char* g, int m, int n, real * matrix)
{
  // open file
  FILE * fout;
  fout = fopen(g,"w");
...
template <class real>
int ReadModesFromDisk(char * g, int * N, int * R, real ** frequencies, real ** modes)
{
  FILE * file;
  file = fopen(g,"r");
...
int ReadModeInfoFromDisk(char * g, int * N, int * R)
{
  FILE * file;
  file = fopen(g,"r");
...
template <class real>
int WriteModesToDisk(char * g, int n, int r, real * frequencies, real * modes)
{
  FILE * file;
  file = fopen(g,"w");
...
template int ReadModesFromDisk<double>(char * g, int * n, int * r, double ** frequencies, double ** modes);
template int ReadModesFromDisk<float>(char * g, int * n, int * r, float ** frequencies, float ** modes);

template int WriteModesToDisk<double>(char * g, int n, int r, double * frequencies, double * modes);
template int WriteModesToDisk<float>(char * g, int n, int r, float * frequencies, float * modes);
...
template int WriteMatrixToDisk<double>(char* g, int m, int n, double * matrix);
template int WriteMatrixToDisk<float>(char* g, int m, int n, float * matrix);

template int WriteMatrixToDisk_<double>(char* g, int m, int n, double * matrix);
template int WriteMatrixToDisk_<float>(char* g, int m, int n, float * matrix);
...
template int ReadMatrixFromDisk<double>(char* g, int * m, int * n, double ** matrix);
template int ReadMatrixFromDisk<float>(char* g, int * m, int * n, float ** matrix);

template int ReadMatrixFromDisk_<double>(char* g, int * m, int * n, double ** matrix);
template int ReadMatrixFromDisk_<float>(char* g, int * m, int * n, float ** matrix);

template int ReadMatrixFromDiskTextFile<double>(char* g, int * m, int * n, double ** matrix);
template int ReadMatrixFromDiskTextFile<float>(char* g, int * m, int * n, float ** matrix);

template int WriteMatrixToDiskTextFile<double>(char* g, int m, int n, double * matrix);
template int WriteMatrixToDiskTextFile<float>(char* g, int m, int n, float * matrix);
